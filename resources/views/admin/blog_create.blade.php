...
<div class="wrapper">
			...
			<form method="POST" action="/admin/blog_create">
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<input id="author" type="text" class="form-control @error('website') is-invalid @enderror" name="author" value="{{ old('author') }}" autocomplete="author" autofocus>
			...
			<div class="form-group row">
				...
				<div class="col-md-6">
					<textarea id="body" name="body" class="form-control tinymce-editor"></textarea>
