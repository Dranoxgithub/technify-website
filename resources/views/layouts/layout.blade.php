...
<body>
	...
	<footer style="background-color:#9ECACC">
		<div class="container-fluid">
			<div class="row d-flex p-2 flex-row flex-md-nowrap flex-wrap justify-content-between align-items-top">
				<div class="col-md-4 p-4 footer-col-1 d-inline-flex flex-row align-items-center">
				...
				<div class="col-md-4 p-2 footer-col-2 mt-4 text-center">
