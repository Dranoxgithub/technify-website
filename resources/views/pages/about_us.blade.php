...
<div class="container bootdey">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-12 pt-2">
                <div class="team text-center rounded p-3 py-4">
                    <img src="images/Riya.png" class="img-fluid avatar avatar-medium shadow rounded-pill profile-pic" alt="">
                    <div class="content mt-3">
                        <h4 class="title mb-0"><a href="https://www.linkedin.com/in/lily-li-58a9821a2/" target="blank" style="color:#26484A">Riya Kabra</a></h4>
                        <small class="text-muted">Product Management</small>
                        <p>Undergraduate student at Duke University studying Computer Science and Economics. Passionate about the intersection of technology in different sectors to make a social impact.</p>
                        <ul class="list-unstyled mt-3 social-icon social mb-0">
                            <li class="list-inline-item"><a href="javascript:void(0)" class="rounded"><i class="mdi mdi-facebook" title="Facebook"></i></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)" class="rounded"><i class="mdi mdi-instagram" title="Instagram"></i></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)" class="rounded"><i class="mdi mdi-twitter" title="Twitter"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-12 pt-2">
                <div class="team text-center rounded p-3 py-4">
                    <img src="images/Naveen.png" class="img-fluid avatar avatar-medium shadow rounded-pill profile-pic" alt="">
                    <div class="content mt-3">
                        <h4 class="title mb-0"><a href="https://www.linkedin.com/in/lily-li-58a9821a2/" target="blank" style="color:#26484A">Naveen Siva</a></h4>
                        <small class="text-muted">Partner Outreach</small>
                        <p>Computer Science and Economics major at Duke interested in pretty much everything. Things I love to do: playing soccer, meeting people, and traveling places.</p>
                        <ul class="list-unstyled mt-3 social-icon social mb-0">
                            <li class="list-inline-item"><a href="javascript:void(0)" class="rounded"><i class="mdi mdi-facebook" title="Facebook"></i></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)" class="rounded"><i class="mdi mdi-instagram" title="Instagram"></i></a></li>
                            <li class="list-inline-item"><a href="javascript:void(0)" class="rounded"><i class="mdi mdi-twitter" title="Twitter"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-12 pt-2">
                <div class="team text-center rounded p-3 py-4">
                    ...
                    <div class="content mt-3">
                        ...
                        <small class="text-muted">Social Media Engagement</small>
            ...
            <div class="col-lg-3 col-md-6 col-12 pt-2">
                <div class="team text-center rounded p-3 py-4">
                    ...
                    <div class="content mt-3">
                        ...
                        <small class="text-muted">Alumna (Design)</small>
