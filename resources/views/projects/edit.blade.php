...
<div class="wrapper container my-4">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="goal" type="text" class="form-control @error('goal') is-invalid @enderror" name="goal" value="{{ $project->goal }}" placeholder="In 1 sentence please ;)" required autocomplete="goal" autofocus>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" placeholder="In 2 - 3 sentences please ;)" required autocomplete="description" autofocus>{{ $project->description }}</textarea>
