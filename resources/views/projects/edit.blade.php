...
<div class="wrapper">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="country" list="country" type="text" class="form-control @error('country') is-invalid @enderror" name="country" value="{{ $project->country }}" required autocomplete="country" autofocus>
            <datalist id="country">
                <option value="Brunei">
