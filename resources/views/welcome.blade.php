...
<section class="sec-1" style="background-color:#429993;">
    <div class="container">
...
<!-- <section class="sec-3 container-fluid p-2 pt-sm-4 pb-sm-4" style="background-color: #F4F4F4">
    <div class="row align-middle">
        <h2 class="m-sm-4 pl-sm-4">Featured Projects</h2>
        <div class="d-flex flex-row flex-md-nowrap flex-wrap justify-content-center p-2"> -->
            {{-- add blade logic for all featured projects --}}
            <div class="card grow p-0 shadow-sm mb-sm-5 mx-sm-5 bg-white rounded m-2 col-md-4">
                <img class="card-img-top" src="/images/technify_cover_card.png" alt="">
...
<!-- <section class="sec-4 container-fluid">
    <div class="row align-middle justify-content-center">
        ...
        <div class="d-flex col-12 pr-3 pl-3flex-row flex-wrap flex-lg-nowrap justify-content-around align-items-center">
            <div class="p-2 mb-2 ml-sm-5">
                <img class="img-sponsor1" src="/images/US.png" alt="">
            </div>
            <div class="p-2 mb-2">
                <img class="img-sponsor2" src="/images/yseali.png" alt="">
            ...
            <div class="p-2">
                <img class="mr-sm-5 img-sponsor4" src="/images/colab.png" alt="">
            </div>
        </div>
        <div class="p-2 m-2">
...
<section class="sec-5 mb-5">
    <div class="container">
        ...
        <div class="row justify-content-around align-items-center">
            ...
            <a class="btn btn-lg btn-primary py-3 px-5" href="/register?type=student" style="background-color: #26484A">
                Apply as Volunteer
            </a>
<!-- <section class="sec-5 container-fluid pt-5">
    <div class="row p-2 pb-5 mb-4 align-middle justify-content-center text-center">
        ...
        <div class="d-flex col-md-8 flex-row flex-wrap flex-md-nowrap justify-content-around align-items-center mb-4 mt-3">
            ...
            <!-- <a class="btn btn-lg btn-primary p-3 pr-5 pl-5" href="/register?type=student" style="background-color: #26484A">  -->
